...
def makePlane(planeType):
    ...
    f.write('"Fuselage Length (cm)",' + rand(18, 27) + '\n')
    f.write('"Wing X Location (cm)",' + rand(18, 27) + '\n')
    f.write('"Stabilizer X Location (cm)",' + rand(18, 27) + '\n')
    f.write('"Vertical Tail X Location (cm)",' + rand(18, 27) + '\n')
    f.write('"Mass at the nose (g)",' + rand(0, 30) + '\n')
    f.write('"Throwing Velocity (km/hr)",20\n')
    f.write('"Wing Span (cm)",' + rand(1, 27) + '\n')
    ...
    f.write('"Stabilizer Span (cm)",' + rand(1, 27)+ '\n')
    ...
    f.write('"Vertical Tail Height (cm)",' + rand(1, 27) + '\n')
    ...
    f.write('"maximum wing span (cm)",27\n')
    f.write('"maximum wing width (cm)",11\n')
    f.write('"wing thickness (cm)",.32\n')
    f.write('"wing density (kg/m^3)",.16\n')
    f.write('"max fuselage length (cm)",27\n')
